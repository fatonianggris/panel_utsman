...
// Class definition
    ...
    var KTDatatableHtmlTableDemo = function () {
        ...
        var demo = function () {
            ...
            var datatable = $('#kt_datatable_presence_academic_homeroom').KTDatatable({
                data: {
                    pageSize: "500",
                },
                search: {
...
//
            ...
            $('#kt_datatable_search_gender', '#kt_datatable_search_status_student', '#kt_datatable_search_status_presence', '#kt_datatable_search_schoolyear').selectpicker();
        };
