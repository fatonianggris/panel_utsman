...
// Class definition
    ...
    var KTDatatableHtmlTableDemo = function () {
        ...
        var demo = function () {
            ...
            $('#kt_datatable_search_track').on('change', function () {
                datatable.search($(this).val().toLowerCase(), 'Jalur');
            });
            ...
            $('#kt_datatable_search_schoolyear', '#kt_datatable_search_gender', '#kt_datatable_search_grade', '#kt_datatable_search_grade_lvl', '#kt_datatable_search_class', '#kt_datatable_search_track', '#kt_datatable_search_status').selectpicker();
