...
// $config['google_site_key'] = '6Lfp3AkfAAAAAFlN72B6D5TzxjgNP7qivu1af5HT';
// $config['google_secret_key'] = '6Lfp3AkfAAAAAHrEtLdBTl82bjaX3sbkB48Cv8uY';
...
$config['csrf_exclude_uris'] = array(
    ...
    'employee/master/employe/post_employe',
    'employee/master/employe/update_employe/[0-9a-z]+',
    'employee/master/student/post_student'.
    'employee/master/student/update_student/[0-9a-z]+',
    'employee/configuration/datalocation/showAllDataLocation',
    'employee/configuration/datalocation/storeMd5Location',
    'employee/configuration/datalocation/storeLocation',
    'employee/configuration/datalocation/deleteLocationTable',
    'employee/settings/account/check_nik_profile',
    'employee/settings/account/check_nip_profile',
    ...
    'present/history/present/timer_clock',
    'present/history/present/check_location',
    'students/settings/account/check_nisn_student',
    'students/settings/account/update_student_biodata',
);
/*
  |--------------------------------------------------------------------------
  | Output Compression
